    ...
    if product:
        ...
        st.markdown(
            ...
            <style>
              ...
              .product-page-flex .product-info {
                flex: 2 1 0% !important;
                min-width: 0 !important;
              }
              .product-page-flex .product-info h2 {
              ...
              .product-page-flex .product-info .price-row {
                display: flex !important;
              ...
              .product-page-flex .product-info .price-row .dotted-fill {
                flex: 1 !important;
                min-width: 12px !important;
                height: 0 !important;
                border-bottom: 2px dotted rgba(255,255,255,0.35) !important;
                margin: 0 8px 8px 0 !important;
                align-self: flex-end !important;
              }
              .product-page-flex .product-info .price-row .price {
                margin: 0 !important;
              ...
              .product-page-flex .product-info .caption {
                margin-top: 8px !important;
                font-size: 0.85em !important;
                color: rgba(255,255,255,0.7) !important;
                font-family: 'Patrick Hand', cursive !important;
              }
              .product-page-flex .product-img-wrap {
                flex: 1 1 0% !important;
                min-width: 0 !important;
                max-width: 200px !important;
              }
              .product-page-flex .product-img-wrap img {
                width: 100% !important;
              ...
              @media screen and (max-width: 480px) {
                .product-page-flex { gap: 12px !important; }
                .product-page-flex .product-info h2 { font-size: 1.35em !important; }
                .product-page-flex .product-info .price-row .price { font-size: 1.2em !important; }
                .product-page-flex .product-img-wrap { max-width: 130px !important; }
              }
            </style>
            """,
        ...
        if not is_admin_access:
            st.markdown(
                ...
                <style>
                  ...
                  /* Chalkboard နောက်ခံ – customer မြင်ကွင်း */
                  ...
                  .chalkboard-page {
                    background: linear-gradient(145deg, #1e1e1e 0%, #2d2d2d 50%, #252525 100%) !important;
                    border: 3px dashed rgba(255,255,255,0.25) !important;
                    border-radius: 12px !important;
                    padding: 24px !important;
                    margin: 0 auto 16px auto !important;
                    box-shadow: inset 0 0 60px rgba(0,0,0,0.2), 0 8px 24px rgba(0,0,0,0.3) !important;
                  }
                  .chalkboard-page .chalkboard-title {
                    font-family: 'Caveat', cursive !important;
                  ...
                  .chalkboard-page .product-page-flex .product-info h2,
                  .chalkboard-page .product-page-flex .product-info .price,
                  .chalkboard-page .product-page-flex .product-info .caption {
                    color: #e8e8e8 !important;
                  }
                  .chalkboard-page .product-page-flex .product-info .price-row .price { color: #fff !important; }
                  section.main [data-testid="stVerticalBlock"] > div { color: #e0e0e0 !important; }
                  section.main a { color: #87ceeb !important; }
                </style>
                """,
                unsafe_allow_html=True,
            )

        # Customer မြင်ကွင်း: chalkboard ဘောင်ထဲမှာ ပစ္စည်းပြမယ်
        name_esc = html.escape(product['name'])
        price_esc = html.escape(str(display_price))
        caption_html = ""
        if has_qr_price:
            orig_esc = html.escape(str(product['price']))
            caption_html = f'<p class="caption">💡 QR ဈေးနှုန်း (မူလ: {orig_esc})</p>'
        img_html = ""
        if cat_img_url:
            url_esc = html.escape(cat_img_url)
            img_html = f'<div class="product-img-wrap"><img src="{url_esc}" alt="{name_esc}" loading="lazy" /></div>'

        # ဈေးနှုန်းကို dotted line နဲ့ ညာဘက်မှာ (menu board လို)
        price_row = (
            '<div class="price-row">'
            '<span class="dotted-fill"></span>'
            f'<span class="price">💰 {price_esc}</span>'
            '</div>'
        )
        card_inner = (
        ...
        if not is_admin_access:
            card = f'<div class="chalkboard-page"><p class="chalkboard-title">📦 {name_esc}</p>{card_inner}</div>'
